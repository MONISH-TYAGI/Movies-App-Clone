                ...
                <ul class="list-group favourites-genres">
                 {
                    this.state.genres.map((genre)=>(
                        ...
                        <li class="list-group-item" style={{background:'blue',color:'white',fontWeight:'bold'}}>{genre}</li>
                        :
                        <li class="list-group-item" style={{background:'white',color:'blue',fontWeight:'bold'}}onClick={()=>{this.handleClick(genre)}}>{genre}</li>
                  ...
                  <table class="table">
                    <thead>
                      <tr>
                        ...
                        <th scope="col"><i class="fa-solid fa-caret-up" onClick={this.sortPopularityDesc}></i>Popularity<i class="fa-solid fa-caret-down" onClick={this.sortPopularityAsec}></i></th>
                        <th scope="col"><i class="fa-solid fa-caret-up" onClick={this.sortRatingsDesc}></i>Rating<i class="fa-solid fa-caret-down"onClick={this.sortRatingAsec}></i></th>
                        <th scope="col"></th>
                      </tr>
                    </thead>
                    <tbody>
